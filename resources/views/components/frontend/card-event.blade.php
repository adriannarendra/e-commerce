...
<div class="group rounded-2xl w-full overflow-hidden relative min-h-[297px] bg-slate-700">
    <!-- Popular badge -->
    @if ($isPopuler)
    ...
    <div
        class="p-5 w-full bg-slate-700 flex flex-col absolute h-full group-hover:-translate-y-[70%] transition ease-in-out duration-300">
